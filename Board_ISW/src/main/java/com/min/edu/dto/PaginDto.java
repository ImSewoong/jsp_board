...
public class PaginDto {
	...
	public PaginDto(int page, int countList, int totalCount, int countPage, int totalPage, int stagePage, int endPage) {
		super();
		this.page = page;
	...
	public String toString() {
		return "PaginDto [page=" + page + ", countList=" + countList + ", totalCount=" + totalCount + ", countPage="
